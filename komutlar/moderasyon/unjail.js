module.exports = {
  name: "unjail",
  code: `
  $channelSendMessage[$getServerVar[cezalog];{newEmbed:{author:Bir üye jailden çıkarıldı!}{field:Kullanıcı:$userTag[$message[1]] - \`($message[1])\`}{field:Yetkili:<@$authorID> - \`($authorID)\`}{color:010307}{footer:Developed by ParzivâL}{thumbnail:$userAvatar[$message[1]]}}]
